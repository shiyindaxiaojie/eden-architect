...
public class UndertowSSLAutoConfiguration {
	...
	private static final String MSG_CONFIG_UNDERTOW_SSL = "Configuring Undertow Setting user cipher suite order to true";

	private final UndertowServletWebServerFactory factory;

	public UndertowSSLAutoConfiguration(UndertowServletWebServerFactory undertowServletWebServerFactory) {
