...
public class LogstashAutoConfiguration {
  ...
  private static final String MSG_INJECT_LOGSTASH_APPENDER = "Autowired Logstash Appender";

  private static final String MSG_INJECT_CONSOLE_APPENDER = "Autowired Console Appender";
