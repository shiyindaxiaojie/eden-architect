...
public class LogstashUtils {
	...
	private static final String INIT_LOGSTASH_CONSOLE_APPENDER = "Initializing Logstash Console Appender";

	private static final String INIT_LOGSTASH_TCP_SOCKET_APPENDER = "Initializing Logstash TCP Socket Appender";
	...
	public static void addContextListener(LoggerContext context, String customFields, LogstashProperties properties) {
	...
	private static class LogbackLoggerContextListener extends ContextAwareBase implements LoggerContextListener {
		...
		private LogbackLoggerContextListener(LogstashProperties logstashProperties, String customFields) {
