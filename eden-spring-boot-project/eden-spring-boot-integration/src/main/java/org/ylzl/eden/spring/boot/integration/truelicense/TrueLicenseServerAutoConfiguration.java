...
import org.ylzl.eden.spring.boot.integration.truelicense.manager.LicenseStore;
...
public class TrueLicenseServerAutoConfiguration {
  ...
  private static final String MSG_INJECT_TRUE_LICENSE_STORE = "装配 TureLicense storing service";
