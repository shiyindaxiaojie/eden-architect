...
public class OAuth2AccessTokenClientAdapter implements OAuth2AccessTokenClient {
	...
	private static final String MSG_REQ_TOKEN_FAILED = "Request token failed from OAuth Server, statue code: {}";

	private static final String MSG_REQ_TOKEN_EXCEPTION = "Request token failed from OAuth Server, caught exception: {}";

	private static final String MSG_NONE_PROP_TOKEN_URI = "No access-token-uri configured in application properties";

	private final RestTemplate restTemplate;

	private final OAuth2Properties.Authorization oAuth2Properties;

	public OAuth2AccessTokenClientAdapter(RestTemplate restTemplate, OAuth2Properties oAuth2Properties) {
	...
	public OAuth2AccessToken getOAuth2AccessToken(HttpEntity<MultiValueMap<String, String>> entity) {
		try {
			...
			ResponseEntity<OAuth2AccessToken> responseEntity = restTemplate.postForEntity(tokenUri, entity, OAuth2AccessToken.class);
