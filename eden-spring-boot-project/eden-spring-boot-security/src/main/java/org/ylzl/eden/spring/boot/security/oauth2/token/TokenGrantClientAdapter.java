...
public class TokenGrantClientAdapter implements TokenGrantClient {
    ...
    private static final String MSG_NONE_PROP_PASSWORD_CLIENT = "No client of password-grant configured in oauth2 properties";

    private static final String MSG_NONE_PROP_PASSWORD_SECRET = "No secret of password-grant configured in oauth2 properties";

    private static final String MSG_PASSWORD_GRANT = "Send password-grant to refresh token from OAuth Server, username = {}";

    private static final String MSG_NONE_PROP_REFRESH_CLIENT = "No client of refresh-token-grant configured in oauth2 properties";

    private static final String MSG_NONE_PROP_REFRESH_SECRET = "No secret of refresh-token-grant configured in oauth2 properties";

    private static final String MSG_REFRESH_TOKEN_GRANT = "Send refresh-token-grant to refresh token from OAuth Server, refreshToken = {}";

    private static final String MSG_NONE_PROP_CLIENT_CLIENT = "No client of client-credentials-grant configured in oauth2 properties";

    private static final String MSG_NONE_PROP_CLIENT_SECRET = "No secret of client-credentials-grant configured in oauth2 properties";

    private static final String MSG_CLIENT_GRANT = "Send client-credentials-grant to get token from OAuth Server";
    ...
    public TokenGrantClientAdapter(OAuth2AccessTokenClient oAuth2AccessTokenClient, OAuth2Properties oAuth2Properties) {
    ...
    private void addAuthentication(HttpHeaders httpHeaders, MultiValueMap<String, String> formParams) {
    ...
    private void addAuthentication(HttpHeaders httpHeaders, String client, String secret) {
        ...
        String authorizationHeader = AuthenticationTypeEnum.BASIC_AUTH.getAuthorization(
