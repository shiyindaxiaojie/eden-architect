...
import org.ylzl.eden.spring.boot.security.oauth2.endpoint.OAuth2TokenEndpoint;
import org.ylzl.eden.spring.boot.security.oauth2.token.*;
import org.ylzl.eden.spring.boot.security.oauth2.token.cookie.OAuth2CookieHelper;
import org.ylzl.eden.spring.boot.security.oauth2.token.cookie.OAuth2CookieTokenExtractor;
import org.ylzl.eden.spring.boot.security.oauth2.token.jwt.JwtTokenProcessor;
import org.ylzl.eden.spring.boot.security.oauth2.token.jwt.RemotedJwtAccessTokenConverter;
import org.ylzl.eden.spring.boot.security.oauth2.token.jwt.SignatureVerifierClient;
import org.ylzl.eden.spring.boot.security.oauth2.token.jwt.SignatureVerifierClientAdapter;
...
public class OAuth2AuthorizationClientAutoConfiguration {
  ...
  private static final String MSG_INJECT_TOKEN_GRANT_CLIENT = "Autowired TokenGrantClient";

  private static final String MSG_INJECT_TOKEN_EXTRACTOR =
      "Autowired TokenExtractor (OAuth2CookieTokenExtractor)";

  private static final String MSG_INJECT_OAUTH2_COOKIE_HELPER = "Autowired OAuth2CookieHelper";

  private static final String MSG_INJECT_OAUTH2_TOKEN_ENDPOINT = "Autowired OAuth2TokenEndpoint";
  ...
  public static class OAuth2AuthorizationClientJwtConfiguration {
    ...
    private static final String MSG_INJECT_SIGN_VERIFY_CLIENT = "Autowired SignatureVerifierClient";
