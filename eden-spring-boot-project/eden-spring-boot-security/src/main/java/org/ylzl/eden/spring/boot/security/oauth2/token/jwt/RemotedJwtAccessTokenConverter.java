...
public class RemotedJwtAccessTokenConverter extends JwtAccessTokenConverter {
    ...
    private static final String MSG_REQ_PUBLIC_KEY = "Public key retrieved from OAuth2 server to create SignatureVerifier";

    private static final String MSG_REQ_PUBLIC_KEY_EXCEPTION = "Could not get public key from OAuth2 server to create SignatureVerifier, caught exception: {}";
    ...
    public RemotedJwtAccessTokenConverter(SignatureVerifierClient signatureVerifierClient, OAuth2Properties oAuth2Properties) {
    ...
    protected Map<String, Object> decode(String token) {
        try {
            ...
            if (ttl > 0L && lastKeyFetchTimestamp > 0L && System.currentTimeMillis() - lastKeyFetchTimestamp > ttl) {
