...
@Getter
@Setter
@ConfigurationProperties(prefix = SecurityConstants.PROP_PREFIX + ".oauth2")
public class OAuth2Properties {
    ...
    public static class Authorization {
        ...
        private String publicTokenKeyUriServiceId = OAuth2Defaults.Authorization.publicTokenKeyUriServiceId;

        private Long publicTokenKeyRefreshRateLimit = OAuth2Defaults.Authorization.publicTokenKeyRefreshRateLimit;
        ...
        public static class ClientCredentials {
            ...
            private Integer accessTokenValiditySeconds = OAuth2Defaults.Authorization.ClientCredentials.accessTokenValiditySeconds;
        ...
        public static class Code {
            ...
            private Integer accessTokenValiditySeconds = OAuth2Defaults.Authorization.Code.accessTokenValiditySeconds;

            private Integer refreshTokenValiditySeconds = OAuth2Defaults.Authorization.Code.refreshTokenValiditySeconds;

            private String[] scopes = OAuth2Defaults.Authorization.Code.scopes;

            private String[] registeredRedirectUris = OAuth2Defaults.Authorization.Code.registeredRedirectUris;
        }
        ...
        public static class Implicit {
			...
			private Integer accessTokenValiditySeconds = OAuth2Defaults.Authorization.Implicit.accessTokenValiditySeconds;
        }
        ...
        public static class Password {
            ...
            private Integer accessTokenValiditySeconds = OAuth2Defaults.Authorization.Password.accessTokenValiditySeconds;

            private Integer refreshTokenValiditySeconds = OAuth2Defaults.Authorization.Password.refreshTokenValiditySeconds;
