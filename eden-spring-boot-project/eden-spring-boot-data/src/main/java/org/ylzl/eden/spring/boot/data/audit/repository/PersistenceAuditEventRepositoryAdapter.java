...
public abstract class PersistenceAuditEventRepositoryAdapter implements AuditEventRepository {
	...
	public PersistenceAuditEventRepositoryAdapter(PersistenceAuditEventRepository persistenceAuditEventRepository, AuditEventConverter auditEventConverter) {
    ...
    public List<AuditEvent> find(Date after) {
        Iterable<PersistentAuditEvent> persistentAuditEvents = persistenceAuditEventRepository.findByEventDateAfter(after);
        return auditEventConverter.convertToAuditEvent(persistentAuditEvents);
    }

    @Override
    public List<AuditEvent> find(String principal, Date after) {
        Iterable<PersistentAuditEvent> persistentAuditEvents = persistenceAuditEventRepository.findByPrincipalAndEventDateAfter(principal, after);
        return auditEventConverter.convertToAuditEvent(persistentAuditEvents);
    }
