...
public class RedisBloomFilter<T> {
	...
	interface Strategy extends java.io.Serializable {
		...
		<T> boolean put(RedisTemplate<String, T> redisTemplate, String key, T value, int numHashFunctions, Funnel<? super T> funnel);

		<T> boolean mightContain(RedisTemplate<String, T> redisTemplate, String key, T value, int numHashFunctions, Funnel<? super T> funnel);
	}
	...
	private RedisBloomFilter(RedisTemplate<String, T> redisTemplate, String key, int numHashFunctions, Funnel<? super T> funnel,
							 Strategy strategy) {
	...
	static <T> RedisBloomFilter<T> create(RedisTemplate<String, T> redisTemplate, String key, Funnel<? super T> funnel,
