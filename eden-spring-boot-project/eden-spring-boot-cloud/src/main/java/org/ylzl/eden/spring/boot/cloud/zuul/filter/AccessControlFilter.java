...
public class AccessControlFilter extends ZuulFilter {
    ...
    private static final String MSG_ALLOWING_ACCESS = "Access Control: allowing access for {}, as no access control policy has been set up for service: {}";

    private static final String MSG_FILTER_UNAUTHORIZED_ACCESS = "Access Control: filtered unauthorized access on endpoint {}";
    ...
    private boolean isAuthorizedRequest(String serviceUrl, String serviceName, String requestUri) {
        Map<String, List<String>> authorizedMicroservicesEndpoints = zuulProperties.getAccessControl().getAuthorizedMicroservicesEndpoints();
