...
package org.ylzl.eden.spring.boot.commons.lang.reflect;
...
public class ReflectionUtils {
    ...
    public static void setField(@NonNull Object destObj, @NonNull String fieldName, Object... argument)
        throws IllegalArgumentException, IllegalAccessException, SecurityException {
        Field field = getDeclaredField(destObj, fieldName);
        setField(destObj, field, argument);
    }

    public static Object getField(@NonNull Object destObj, @NonNull Field field) throws IllegalArgumentException, IllegalAccessException {
        setAccessible(field);
        return field.get(destObj);
    }

    public static Object getField(@NonNull Object destObj, @NonNull String fieldName) throws IllegalArgumentException,
        IllegalAccessException, SecurityException {
        Field field = getDeclaredField(destObj, fieldName);
        return getField(destObj, field);
    }

    public static Field getDeclaredFields(@NonNull Class<?> clazz, @NonNull String fieldName) throws SecurityException {
    ...
    public static Field getDeclaredField(@NonNull Object destObj, @NonNull String fieldName) throws SecurityException {
    ...
    public static Object invokeMethod(@NonNull Object object, @NonNull String methodName, Class<?>[] parameterTypes,
                                      Object[] parameters) throws SecurityException, IllegalAccessException, IllegalArgumentException,
    ...
    public static Method getSetter(@NonNull Class<?> clazz, @NonNull Field field, Class<?>... parameterTypes) throws SecurityException {
        String fieldName = field.getName();
        String methodName = "set" + fieldName.substring(0, 1).toUpperCase() + fieldName.substring(1);
        return getDeclaredMethod(clazz, methodName, parameterTypes);
    }

    public static Method getGetter(@NonNull Class<?> clazz, @NonNull final Field field) throws SecurityException {
        String fieldName = field.getName();
