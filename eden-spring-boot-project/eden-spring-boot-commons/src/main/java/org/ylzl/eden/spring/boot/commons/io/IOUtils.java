...
public class IOUtils extends org.apache.commons.io.IOUtils {
	...
	public static long transferFrom(FileChannel inChannel, FileChannel outChannel) throws IOException {
	...
	public static long transferFrom(FileInputStream in, String destPath) throws IOException {
		try (FileChannel inChannel = in.getChannel();
			 FileChannel outChannel = FileChannel.open(Paths.get(destPath),
				 EnumSet.of(StandardOpenOption.CREATE_NEW, StandardOpenOption.TRUNCATE_EXISTING, StandardOpenOption.WRITE))) {
	...
	public static long transferFrom(String srcPath, FileOutputStream out) throws IOException {
		try (FileChannel inChannel = FileChannel.open(Paths.get(srcPath), EnumSet.of(StandardOpenOption.READ));
	...
	public static long allocate(String srcPath, OutputStream out, boolean isDirect) throws IOException {
		long start = System.currentTimeMillis();
		int bufferSize = 4096;
	...
	public static long seek(String srcPath, OutputStream out, long startByte, long endByte) throws IOException {
