...
package org.ylzl.eden.spring.boot.audit.repository;
 ...
 */
@NoRepositoryBean
public interface PersistenceAuditEventRepository<T extends PersistenceAuditEvent, ID extends Serializable> extends JpaRepository<T, ID> {
