...
package org.ylzl.eden.spring.test.container.sentinel;
...
public class SentinelDashboardContainer extends GenericContainer<SentinelDashboardContainer> {
	...
	public SentinelDashboardContainer(String version) {
		this(DEFAULT_IMAGE_NAME.withTag(version), DEFAULT_STARTUP_TIMEOUT);
	}

	public SentinelDashboardContainer(DockerImageName dockerImageName, Duration startUpTimeOut) {
