...
import org.ylzl.eden.data.masker.builder.AbstractDataMaskerBuilder;
...
public class CharsScanDataMaskerBuilder extends AbstractDataMaskerBuilder implements DataMaskerBuilder {
	...
	public DataMasker build() {
		...
		return new CharsScanDataMasker(charsScanBs);
	}
}
