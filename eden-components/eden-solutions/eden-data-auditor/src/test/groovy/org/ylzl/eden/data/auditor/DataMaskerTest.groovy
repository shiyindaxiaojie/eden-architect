...
import org.ylzl.eden.data.auditor.integration.masker.jackson.JacksonDataMaskingModule
import org.ylzl.eden.data.auditor.masker.DataMaskerManager
import org.ylzl.eden.data.auditor.masker.support.DataMaskerHelper
...
class DataMaskerTest extends Specification {
	...
	def "test json masking"() {
		...
		where:
		spi        	|| 	maskedJson
		"jackson"	||  "{\"address\":\"广州市****区梅赛德斯奔驰91****\",\"chineseName\":\"梦*歌\",\"idCard\":\"4401****0011\",\"mobilePhone\":\"135****8900\"}"
	}
}
