...
public class EncryptException extends RuntimeException {
	...
	public EncryptException(String message, Throwable cause, Object... params) {
		super(MessageFormatUtils.format(message, params), cause);
	}

	protected EncryptException(String message, Throwable cause, boolean enableSuppression,
