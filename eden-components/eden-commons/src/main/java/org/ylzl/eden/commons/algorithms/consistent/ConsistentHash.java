...
package org.ylzl.eden.commons.algorithms.consistent;
...
public class ConsistentHash<T> {
  ...
  /**
   * 环形存储虚拟节点的哈希值到真实节点的映射 <br>
   * 如果是 JDK1.8 使用 <code>ConcurrentSkipListMap</code> 更好
   */
  @Getter private final SortedMap<Integer, T> circle = new TreeMap<Integer, T>();
