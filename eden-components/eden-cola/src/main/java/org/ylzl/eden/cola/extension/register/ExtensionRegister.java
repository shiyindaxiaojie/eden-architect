...
public class ExtensionRegister {
	...
	private void saveInExtensionClasses(Object extensionInstance, Class<?> extensionClass, Extension extension) {
		...
		ExtensionCoordinate extensionCoordinate = buildExtensionCoordinate(extensionClass, bizScenario.getUniqueIdentity());
	...
	private ExtensionCoordinate buildExtensionCoordinate(Class<?> extensionClass, String uniqueIdentity) {
