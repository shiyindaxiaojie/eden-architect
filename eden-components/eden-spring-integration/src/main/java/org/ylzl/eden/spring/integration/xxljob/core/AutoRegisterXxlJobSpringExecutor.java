...
import org.ylzl.eden.spring.integration.xxljob.annotations.XxlJobRegister;
import org.ylzl.eden.spring.integration.xxljob.core.dto.XxlJobGroup;
import org.ylzl.eden.spring.integration.xxljob.core.dto.XxlJobInfo;
			...
			try {
				annotatedMethods = MethodIntrospector.selectMethods(bean.getClass(),
					new MethodIntrospector.MetadataLookup<XxlJob>() {
						@Override
						public XxlJob inspect(@NotNull Method method) {
