...
package org.ylzl.eden.spring.integration.flowable;
...
public class CustomFlowableAutoConfiguration implements ProcessEngineConfigurationConfigurer {
  ...
  public void configure(SpringProcessEngineConfiguration springProcessEngineConfiguration) {
    ...
    springProcessEngineConfiguration.setActivityFontName(SpringFrameworkConstants.DEFAULT_FONT_NAME);
    springProcessEngineConfiguration.setLabelFontName(SpringFrameworkConstants.DEFAULT_FONT_NAME);
