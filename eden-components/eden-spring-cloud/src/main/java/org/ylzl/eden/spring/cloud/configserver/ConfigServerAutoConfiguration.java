...
package org.ylzl.eden.spring.cloud.configserver;
...
@EnableConfigServer
@Profile(SpringProfileConstants.SPRING_PROFILE_NATIVE)
@Slf4j
@Configuration
public class ConfigServerAutoConfiguration {

  public static final String EXP_CONFIG_SERVER_ENABLED =
      "${" + SpringFrameworkConstants.PROP_SPRING_PREFIX + ".cloud.config.server.bootstrap:true}";
