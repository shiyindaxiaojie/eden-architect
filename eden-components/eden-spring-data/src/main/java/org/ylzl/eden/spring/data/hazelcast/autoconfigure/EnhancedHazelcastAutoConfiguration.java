...
package org.ylzl.eden.spring.data.hazelcast.autoconfigure;
...
import org.ylzl.eden.spring.data.hazelcast.env.EnhancedHazelcastProperties;
import org.ylzl.eden.spring.framework.core.autoconfigure.SpringFrameworkAutoConfiguration;
import org.ylzl.eden.spring.framework.core.constant.SpringFrameworkConstants;
import org.ylzl.eden.spring.framework.info.autoconfigure.InfoContributorAutoConfiguration;
 ...
 * @since 1.0.0
 */
@AutoConfigureAfter({SpringFrameworkAutoConfiguration.class, InfoContributorAutoConfiguration.class})
...
public class EnhancedHazelcastAutoConfiguration implements DisposableBean {
  ...
  public static final String EXP_HAZELCAST_ENABLED =
      "${" + SpringFrameworkConstants.PROP_PREFIX + ".hazelcast.enabled:true}";
